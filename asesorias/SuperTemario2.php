  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav navbar-right">
      <li class="page-scroll">
        <a href="inicioAsesor.php#perfil/<?php echo $_SESSION['id']; ?>" ><img <?php echo 'src="'.$_SESSION['imagen'].'"';?> style="width: 30px; height: 30px; ">
     ...
     <li class="dropdown">
        ...
        <a href="inicioAsesor.php#/foro">Foro para Java</a></li>
        ...
        <li class="page-scroll">
            <a href="inicioAsesor.php#/administrar-usuarios" >Usuarios</a>
        </li>
        <li class="page-scroll">
