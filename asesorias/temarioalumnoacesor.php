...
session_start();
    ...
    if ($_SESSION['tipo_usuario']!='Alumno Asesor')  {
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav navbar-right">
      <li class="page-scroll">
        <a href="inicioAlumnoAsesor.php#/perfil/<?php echo $_SESSION['id']; ?>" ><img <?php echo 'src="'.$_SESSION['imagen'].'"';?> style="width: 30px; height: 30px; ">
     ...
     <li class="dropdown">
        ...
        <a href="inicioAlumnoAsesor.php#/foro">Foro para Java</a></li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
            <li><a href="inicioAlumnoAsesor.php#/foro">En Java</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="#">En C</a></li>
            </ul>
        </li>
...
<br/>
 ...
 <button id="espera" name="espera" type="submit" onclick="esperaalumno()" value="espera" class="btn btn-primary btn-lg" ;>En espera</button> 
 </div> 
